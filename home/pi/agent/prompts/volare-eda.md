---
description: Run safe read-only EDA on Volare PostgreSQL (volare-prod)
argument-hint: "<table-or-topic> [focus]"
---

Use the volare-psql skill and the volare_psql_check / volare_psql_query tools to perform safe read-only EDA for: $ARGUMENTS
